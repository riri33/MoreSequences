...
def run_test_make_less_simple_string():
    ...
    print('Actual:  ', actual)
    expected = '5'
    actual = make_less_simple_string(5,5)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        point1 = rg.Point(center.x - circle.radius, center.y + circle.radius)
        point2 = rg.Point(center.x + circle.radius, center.y - circle.radius)
